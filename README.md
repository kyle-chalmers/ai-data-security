...
for live DB audits; docker only if you run the test suite. `/doctor` checks all of these.
...
| `/ai-data-security:ai-config-audit <path>` | Permission deny/allow rules, Bash sandbox posture, MCP configs across Claude/Cursor/Gemini/Codex, plaintext transcripts, retention-tier guidance |
